      ...
      <Link href={`/designs/${slug}`} className="block h-full w-full">
        <motion.div
          ...
          whileHover={{
            ...
            boxShadow:
              "0 5px 15px rgba(239, 68, 68, 0.1), 0 0 25px rgba(239, 68, 68, 0.03)",
          }}
          whileTap={{ scale: 0.98 }}
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {count}
                <span className="text-xs sm:text-xs md:text-sm font-normal text-white/60 ml-1">
                  éléments
                </span>
              </motion.div>
              ...
              >
                <span className="text-xs sm:text-sm font-medium uppercase tracking-wider sm:tracking-widest">
                  Explorer
                </span>
                <motion.div
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(239, 68, 68, 0.05) 0%, transparent 50%)",
              opacity: isHovered ? 1 : 0,
            }}
            transition={{ duration: 0.3 }}
          />
...
export default function DesignsSection({
  ...
  return (
    <section
      id="designs"
      className="min-h-screen bg-black relative overflow-x-hidden pt-20 sm:pt-24 md:pt-28"
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at 30% 50%, rgba(239, 68, 68, 0.1) 0%, transparent 60%)",
        }}
        animate={{
          background: [
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-8 md:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3 md:gap-4 lg:gap-5 w-full">
          {categories.map((category, index) => (
            <div
              key={category.slug}
              className="min-h-[200px] sm:min-h-[240px] md:min-h-[280px] lg:min-h-[320px]"
            >
